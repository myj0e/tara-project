const zho = {
    ...
    home: {
        ...
        description: '当前针对关基应用的黑客攻击事件频发，国家安全护网演练中存在对关基应用威胁场景识别不全、攻击路径识别不全、攻击可行性评估不全面不准确的问题，导致RCE类、提权类、敏感信息泄露类安全问题频发，应用和主机被较多攻破。构建全面准确的安全威胁建模能力，并对关基应用进行攻击可行性评估成为安全防护的当务之急。TARA在ISO/SAE 21434国际标准中是外部业界使用的安全分析核心方法。基于TARA安全国标，构建从威胁场景识别->攻击路径分析->攻击可行性评估的安全威胁建模线上能力，有效提升识别关基应用安全威胁全面性和精准度。'
    },
    providers: {
        desktop: {
    ...
    report: {
        options: {
            showOutOfScope: '范围外的元素',
            showMitigatedThreats: '已缓解威胁',
            showModelDiagrams: '模型图',
            showEmpty: '空元素',
            showProperties: '元素属性',
